 ...
 * @since 2023/10/9
 */
public class Corn2Describe {

    /**
     * CORN表达式时间中文名称
     */
    protected static final String[] CRON_TIME_CN = new String[]{"秒", "分钟", "小时", "天", "月", "周", "年"};
     ...
     * 文字说明
     **/
    private static final String FORMAT = "从%s%s开始到%s%s范围内,每隔%s%s";
     ...
     * “4#5”表示第五周的星期三。
     *
     * @param cronExp     {@link String}
     * @param cronTimeArr {@link String[]}
     * @return String
     */
    ...
    private static String appendGapInfo(String time, int rangeNum, int index) {
        ...
        return String.format(FORMAT, startNum, timeUnit, endStr, timeUnit, gapNum, timeUnit);
    }
